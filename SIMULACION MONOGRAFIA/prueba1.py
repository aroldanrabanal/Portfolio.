...
b=((g)/((2*vi**2)*cos(θ)**2))
print ()
ymax=((vi**2)*(np.sin(1)*sin(θ))/(2*g))
xmax=((vi**2)*(np.sin(2*1))/(g))
print ("................................................................................")
print ("................................................................................")
tmax=(vi*sin(θ))/(g)
tv=2*(tmax)
...
#creamos la figura
plt.figure("Simulación",figsize=(10,8),dpi=80,facecolor="y",edgecolor="c")   
plt.axes()
plt.axis('on')
...
# añadimos el titulo
plt.title("Miriam García", fontsize=15,color="blue",
          verticalalignment="baseline",horizontalalignment = "center")  

# añadimos el subtitulo
plt.suptitle("Monografía",fontsize=20,color="red")
...
#mostrar el tiempo real de ejecucion de este proceso :",time()
plt.text(2,np.max(f(x))+1,("fecha/hora:"+str(asctime())),fontsize=10,color="green")
plt.text(2,np.max(f(x))-1,("tiempo(s):"+str(time())),fontsize=10,color="blue")
